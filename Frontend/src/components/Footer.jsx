      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/complaints" className="hover:text-orange-400">Complaints</Link></li>
            <li><Link to="/solves-complaints" className="hover:text-orange-400">Solved Complaints</Link></li>
          </ul>
        </div>
