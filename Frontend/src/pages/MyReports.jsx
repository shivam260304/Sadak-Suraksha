  ...
  return (
    <div className="pt-20 px-4 flex justify-center">
      <div className="w-full max-w-4xl">
        ...
        {/* DEBUG: See what 'filtered' contains */}
        <pre className="mb-4 bg-gray-100 p-2 rounded text-xs">{JSON.stringify(filtered, null, 2)}</pre>
        {/* Remove the above <pre> when not needed */}
        {filtered.length === 0 ? (
              ...
              <div key={report._id || index} className="bg-white shadow p-4 rounded border-l-4 border-blue-600 relative">
                ...
                {report.imageUrl && (
                  <div className="mt-2">
                    ...
                    {/* Make sure imageUrl is a valid URL that your backend exposes! */}
                    <img
                      src={report.imageUrl}
                      alt="Uploaded"
